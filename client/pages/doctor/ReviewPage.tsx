    ...
    <div className="flex items-start justify-between flex-wrap gap-4">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs font-semibold tracking-wide text-emerald-600 mt-0.5">
            {doctor.credentials}
          </p>
    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-5 flex flex-col">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-400">
            {review.verified ? "Verified Patient" : "Patient"} •{" "}
            {review.date}
          </p>
        </div>
      </div>
      ...
      <button
        type="button"
        className="mt-4 flex items-center justify-center gap-2 border border-blue-200 text-blue-700 text-sm font-semibold rounded-lg py-2.5 hover:bg-blue-50 transition-colors"
      >
        <svg
          className="w-4 h-4"
          viewBox="0 0 24 24"
  ...
  return (
    <div className="bg-gray-50 rounded-2xl border border-dashed border-gray-200 p-5 flex flex-col items-center justify-center text-center gap-3 min-h-[240px]">
      ...
      <p className="text-sm text-gray-500">
        {remainingCount.toLocaleString()} more reviews available
      </p>
...
export default function ReviewPage() {
  ...
  const remainingCount =
    DOCTOR_PROFILE.reviewCount - shownCount;
